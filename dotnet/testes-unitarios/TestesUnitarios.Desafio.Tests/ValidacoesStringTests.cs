...
public class ValidacoesStringTests
{
    ...
    public void DeveRetornar6QuantidadeCaracteresDaPalavraMatrix()
    {
        ...
        // Act
        var actual = _validacoes.RetornarQuantidadeCaracteres(texto);
    ...
    public void DeveConterAPalavraQualquerNoTexto()
    {
        ...
        // Act
        var actual = _validacoes.ContemCaractere(texto, textoProcurado);
    ...
    public void TextoDeveTerminarComAPalavraProcurado()
    {
        ...
        // Act
        var actual = _validacoes.TextoTerminaCom(texto, textoProcurado);
